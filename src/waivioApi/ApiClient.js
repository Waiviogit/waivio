...
export const getTransferHistory = (username, operationNum = -1) =>
  new Promise((resolve, reject) => {
    fetch(
      `${config.campaignApiPrefix}${config.payments}${config.transfers_history}?userName=${username}&operationNum=${operationNum}`,
      {
        headers,
        method: 'GET',
      },
