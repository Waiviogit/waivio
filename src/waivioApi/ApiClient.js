...
export const getSocialInfoPost = (author, postPermlink, userName, social) => {
  fetch(
    `${config.apiPrefix}${config.post}${config.social}?author=${author}&permlink=${postPermlink}$userName=${userName}&social=${social}`,
    {
      headers: {
        ...headers,
        app: config.appName,
