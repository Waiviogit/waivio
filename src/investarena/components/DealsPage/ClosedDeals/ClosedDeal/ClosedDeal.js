  ...
  const prices = (
    <Fragment>
      <div
        ...
        className="st-price"
      >
        {quoteFormat(closedDeal.openPrice, closedQuoteSettings)}
      </div>
      <div
        title={intl.formatMessage({ id: 'deals.closePrice', defaultMessage: 'Closing price' })}
        className="st-price"
      >
        {quoteFormat(closedDeal.closePrice, closedQuoteSettings)}
      </div>
    </Fragment>
  );
  const pnlValue = (
      ...
      return (
        <div className="st-open-deal-wrapper st-card">
          ...
          <div className="st-opened">
            ...
            <div
              title={intl.formatMessage({ id: 'deals.closeTime', defaultMessage: 'Closing time' })}
            >
