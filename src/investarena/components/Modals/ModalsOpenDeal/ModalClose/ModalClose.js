    ...
    render () {
        return (
            <div className='st-open-deal-button-wrap st-margin-left-large'>
                ...
                {this.state.modal &&
                  <Modal
                    title={this.props.intl.formatMessage({ id: 'deals.closeAll', defaultMessage: 'Close all' })}
                  ...
                  >
                    <span className='modal-text st-margin-bottom-large'>
                      {this.props.intl.formatMessage({ id: 'modalClose.header.title', defaultMessage: 'Close Deal' })}
                    ...
                    <div className='d-flex'>
                      ...
                      <button className='btn st-open-deal-button-blue st-margin-left-large' onClick={this.handleClickConfirmCloseDeal}>
