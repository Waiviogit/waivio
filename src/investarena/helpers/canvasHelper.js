...
export class CanvasHelper {
    ...
    static getChartInfo (createdAt, forecast, timeNow, canvasWidth, isExpired, timeScale) {
        ...
        const barsBetweenStartAndFinish = CanvasHelper.getBarsBetweenStartAndFinish(forecast, createdAt, minutePerBar);
        let barsAfterStart = CanvasHelper.getBarsAfterStart(timeNow, createdAt, minutePerBar, msecondsPerBar, isExpired);
        ...
        let barsBeforeStart = barsBetweenStartAndFinish >= maxBars ? 3 : maxBars - barsBetweenStartAndFinish;
        ...
        return {
            pxPerGrid, barsPerGrid, pxPerBar, msecondsPerBar, minutePerBar, barsAll, barsAfterStart
        };
    }
    ...
    static getBarsPerGrid = (pxPerBar, minutePerBar) => {
        let barsPerGrid = minutePerBar === MIN_PER_WEEK || minutePerBar === MIN_PER_DAY
