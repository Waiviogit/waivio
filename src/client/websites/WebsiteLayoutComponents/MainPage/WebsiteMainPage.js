    ...
    <div className="WebsiteMainPage">
        ...
        <div className="WebsiteMainPage__wrapperTitle">
          <div>
            <h1 className="WebsiteMainPage__mainTitle">
              <i>{props.intl.formatMessage({id: "earn_rewards", defaultMessage: "Earn rewards"})}</i> {props.intl.formatMessage({id: "photographing_your_meal", defaultMessage: "by photographing your meal at our restaurants."})}
            </h1>
            <h2 className="WebsiteMainPage__secondTitle">
              {props.intl.formatMessage({id: "you_deserve", defaultMessage: "You deserve to get more out of your meals."})}
            </h2>
          </div>
      ...
      <section className="WebsiteMainPage__rewardsSection">
        <h3 className="WebsiteMainPage__rewardsSectionTitle">
          {props.intl.formatMessage({id: "its_easy", defaultMessage: "It’s as easy as one, two, three."})}</h3>
        <ol className="WebsiteMainPage__stepsContainer">
          <li>
            <h4>{props.intl.formatMessage({id: "first_step", defaultMessage: "1. Find the restaurant, choose your dish"})}</h4>
            <div className="WebsiteMainPage__steps">
              ...
              <div className="WebsiteMainPage__stepsBody">
                <h5>
                  ...
                  <i> {props.intl.formatMessage({id: "restaurant_new", defaultMessage: "restaurant"})}</i>, {props.intl.formatMessage({id: "choose_your", defaultMessage: " choose your"})}
                  <i> {props.intl.formatMessage({id: "dish_lowercase", defaultMessage: "dish"})}</i>
                </h5>
          ...
          <li>
            <h4>{props.intl.formatMessage({id: "second_step", defaultMessage: "2. Reserve your reward"})}</h4>
            <div className="WebsiteMainPage__steps">
              <div className="WebsiteMainPage__stepsHeader">
                <span>
                  {props.intl.formatMessage({id: "eat_out_earn_crypto", defaultMessage: "Eat out, earn crypto"})}. |
              ...
              <div className="WebsiteMainPage__stepsBody">
                <h5>
                  <i>{props.intl.formatMessage({id: "reserve_new", defaultMessage: "Reserve"})} </i>
                  {props.intl.formatMessage({id: "your_reward_new", defaultMessage: "your reward"})}
                </h5>
          ...
          <li>
            <h4>{props.intl.formatMessage({id: "step_three", defaultMessage: "3. Share two photos of your dish & earn!"})}</h4>
            <div className="WebsiteMainPage__steps">
              <div className="WebsiteMainPage__stepsHeader">
                <span>
                  {props.intl.formatMessage({id: "eat_out_earn_crypto", defaultMessage: "Eat out, earn crypto"})}. |
              ...
              <div className="WebsiteMainPage__stepsBody">
                <h5>
                  ...
                  {props.intl.formatMessage({id: "two_photos_of_your_dish", defaultMessage: "two photos of your dish & earn!"})}
                </h5>
      ...
      <section className="WebsiteMainPage__withdrawSection">
        <h2 className="WebsiteMainPage__withdrawTitle">
          ...
          {props.intl.formatMessage({id: "easy_too", defaultMessage: "your rewards is easy too."})}
        </h2>
        ...
        <div className="WebsiteMainPage__infoWrapper">
          <p className="WebsiteMainPage__services">
            {props.intl.formatMessage({id: "other_services", defaultMessage: "Other services make withdrawing rewards a headache, so we’ve done better."})}
          </p>
          <p>
            {props.intl.formatMessage({id: "they_offer_rewards", defaultMessage: "They offer rewards that are practically meaningless. Or they’re rewards can only be used on a set list of items. Or their rewards require you to jump through hoops to withdraw."})}
          </p>
          <p>{props.intl.formatMessage({id: "makes_fun", defaultMessage: "Dining.Gifts makes rewards fun, like they’re meant to be."})}</p>
          <p className="WebsiteMainPage__paragraphCurrency">
            ...
            {props.intl.formatMessage({id: "convert_rewards", defaultMessage: "convert rewards you earn into major cryptos, such as"})}{' '}
            <i>{props.intl.formatMessage({id: "three_currency", defaultMessage: "Bitcoin, Ethereum, Litecoin"})} </i>
            {props.intl.formatMessage({id: "directly_cash", defaultMessage: "or directly into cash using any Bitcoin ATM."})}
          </p>
          <p>{props.intl.formatMessage({id: "its_2022", defaultMessage: "It’s 2022. Rewards should be easy!"})}</p>
        </div>
        <Link
