...
const LeftSidebar = () => (
  <Switch>
    ...
    <Route path="/rewards/referral-details" component={SidenavRewards} />
    <Route path="/rewards/referral-instructions" component={SidenavRewards} />
    <Route path="/rewards/referral-status" component={SidenavRewards} />
