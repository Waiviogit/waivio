    ...
    <div className="ChromeExtension">
      ...
      <p className="ChromeExtension__list">
        <ol>
          ...
          <li className="ChromeExtension__list-item">
            Enable Developer Mode by toggling the switch located in the top-right corner of the
            page.
          </li>
      ...
      <p className="ChromeExtension__list">
        <ul>
          ...
          <li className="ChromeExtension__list-ordered-item">
            ...
            scan any Amazon URL and extract ASIN numbers of products from that webpage. It generates
            a search query for Datafiniti&apos;s product search API tab, downloads the file, and
            also instantly copies the information to the clipboard.
          </li>{' '}
          <li className="ChromeExtension__list-ordered-item">
            <span className="ChromeExtension__list-item-underline"> Upload to Waivio</span>: tool
            scans the Amazon URL, generates the required file, and immediately initiates the import
            to Waivio under the currently logged-in user.
          </li>
          <li className="ChromeExtension__list-ordered-item">
            <span className="ChromeExtension__list-item-underline">Create post draft</span>: tool
            can create a post based on a YouTube video using chat GPT.
          </li>
        </ul>
      </p>
      ...
      <p>
        Please note that after each of our updates, you need to reinstall the extension or refresh
        the file and extension to use the most current version.
        <div>
          {' '}
