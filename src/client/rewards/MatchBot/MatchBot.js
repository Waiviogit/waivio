      ...
      <div className="MatchBot__text-content">
        ...
        <p>
          {intl.formatMessage({
            ...
            defaultMessage:
              "For example, the user has posted a review that is eligible to receive a direct reward of 5.00 HBD. Match bot can upvote that post for a specified value of, say, 10% of the reward (assuming Match bot has enough voting value). This way, the user will receive 0.50 HBD in author's rewards and the direct payment can be reduced to 4.50 HBD.",
          })}
        </p>
        <p>
          {intl.formatMessage({
