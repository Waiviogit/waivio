    ...
    <div className="MatchBot__text-content">
      <p>
        {intl.formatMessage({
          ...
          defaultMessage: 'Match bot is designed to offset portion of direct rewards with upvotes',
        })}
        .
      </p>{' '}
      <br />
      <p>
        {intl.formatMessage({
          id: 'user_has_posted_review_eligible_receive_direct_reward',
          defaultMessage:
            'For example, the user has posted a review that is eligible to receive a direct reward of 5.00 SBD',
        })}
        .
        {intl.formatMessage({
          id: 'match_bot_can_upvote_post_specified_value_say_10%_of_reward',
          defaultMessage:
            'Match bot can upvote that post for a specified value of, say, 10% of the reward (assuming Match bot has enough voting value)',
        })}
        .
        {intl.formatMessage({
          id: 'way_user_receive_SBD_rewards',
          defaultMessage:
            "This way, the user will receive 0.50 SBD in author's rewards and the direct payment can be reduced to 4.50 SBD",
        })}
        .
      </p>
      <br />
