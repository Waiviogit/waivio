export default  (messageFactory, validators) => (
  ...
  campaignName: {
    ...
    rules: [
      ...
      {
        max: 100,
        message: messageFactory('campaign_name_error_long','The name of the campaign should not exceed 100 symbols'),
      },
      {
        validator: validators.checkNameFieldIsEmpty
      }
    ],
    caption: messageFactory('campaign_names_used_internal_reports', 'Campaign names are used only for internal reports'),
  },
  campaignType: {
    name: 'type',
    ...
    caption: messageFactory('specific_campaign_parameters_type', 'The campaign parameters are specific to the type of campaign')
  },
  budget: {
    name: 'budget',
    ...
    caption: messageFactory('unused_portion_not_accumulate', 'The unused portion of the budget does not accumulate')
  },
  reward: {
    name: 'reward',
    ...
    caption: messageFactory('reward_portion_using_upvotes_registered_accounts', 'Portion of the reward can be paid using upvotes from registered accounts')
  },
  findSponsors: {
    name: 'findSponsors',
    label: messageFactory('registered_upvoting_accounts_ext','Registered upvoting accounts besides @sponsor (optional, up to 5)'),
    placeholder: messageFactory('sponsor_auto_complete_placeholder','Find sponsor'),
    caption: messageFactory('value_of_upvotes_can_be_accumulated_on_compensation_account',
  ...
  compensationAccount: {
    ...
    placeholder: messageFactory('compensation_account_auto_complete_placeholder','Find compensation account'),
    caption: messageFactory('accumulates_value_of_upvotes_from_registered_upvoting_accounts',
  ...
  reservationPeriod: {
    ...
    initialValue: 1,
    caption: messageFactory('budget_reduced_amount_rewards_reserved','The available budget is reduced by the amount of rewards reserved')
  },
  setTargetDays: {
    name: 'setTargetDays',
    label: messageFactory('target_days_for_reviews','Target days for reviews'),
    caption: messageFactory('reservation_period_will_dynamically_adjusted', 'Reservation period will be dynamically adjusted to match target days'),
  },
  minPhotos: {
    name: 'minPhotos',
  ...
  minSteemReputation: {
    ...
    initialValue: 25,
    caption: messageFactory('users_steem_start_reputation', 'New users on Steem start with reputation of 25')
  },
  minExpertise: {
    name: 'minExpertise',
    ...
    caption: messageFactory('users_start_with_zero_expertise', 'New users on Waivio start with expertise of 0')
  },
  minFollowers: {
    name: 'minFollowers',
  ...
  legalInfo: {
    ...
    p_1: messageFactory('reward_payments_made_directly_waivio_provide_information',
    ...
    p_2: messageFactory('can_add_link_agreement_govern_relationships',
  ...
  description: {
    ...
    rules: [
      {
        max: 250,
        message: messageFactory('campaign_description_longer_250_symbols','Campaign description should be no longer then 250 symbols!'),
      },
    ],
    caption: messageFactory('note_shown_to_users_of_reward', 'This note will be shown to users at the time of reservation of the reward')
  },
  expiredAt: {
    name: 'expiredAt',
  ...
  usersLegalNotice: {
    ...
    caption: messageFactory('note_draw_users_attention_specific_terms',
  ...
  checkboxAgree: {
    ...
    rules: [
      {
        required: true,
        message: messageFactory('read_agreement','Please, read the agreement and check this field'),
      },
    ],
    ...
    textAfterLink: messageFactory('service_acknowledge_campaign_not_violate_laws',
  ...
  commissionToWaivio: {
    ...
    label: messageFactory('agree_to_pay_following_commissions_waivio',
    ...
    initialValue: 5,
    caption: messageFactory('commissions_must_paid_within_14_days',
  ...
  createButton: {
    ...
    spanText: messageFactory('create_button_span_text','Once created, the campaign can be activated in the Campaigns/Manage tab.'),
  },
  editButton: {
    text: messageFactory('edit_button_text', 'Edit'),
    spanText: messageFactory('edit_button_span_text','Once edited, the campaign can be activated in the Campaigns/Manage tab.'),
  },
  }
);
