    ...
    <div className="Details__text-wrap">
      ...
      <div className="Details__criteria-wrap">
        <div className="Details__criteria-row">
          ...
          <div>Minimum Steem reputation: [min Steem reputation]</div>
        </div>
        <div className="Details__criteria-row">
          <Checkbox checked disabled />
          <div>Minimum Waivio expertise: [min. user expertise]</div>
        </div>
        <div className="Details__criteria-row">
          <Checkbox checked disabled />
          <div>Minimum number of followers: [min. followers]</div>
        </div>
        <div className="Details__criteria-row">
          <Checkbox checked disabled />
          <div>Minimum number of posts: [min. posts]</div>
        </div>
        <div className="Details__criteria-row">
          <Checkbox checked disabled />
          <div>
            Have not received a reward from @[campaign sponsor] for reviewing [primary object] in
            the last [frequency days] days and does not have an active reservation for such a reward
            at the moment.
          </div>
        </div>
        <div className="Details__criteria-row">
          <Checkbox checked disabled />
          <div>User account is not blacklisted by @[sponsor] or referenced accounts.</div>
        </div>
      </div>
      ...
      <span>
        The amount of the reward is determined in STEEM at the time of reservation. The reward will
        be paid in the form of a combination of upvotes (Steem Power) and direct payments (liquid
        STEEM). Only upvotes from registered accounts (@[sponsor], @[registered match bots]) count
        towards the payment of rewards. The value of all other upvotes is not subtracted from the
        specified amount of the reward.
      </span>
