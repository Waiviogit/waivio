...
export const imageRegex = /https?:\/\/(?:[-a-zA-Z0-9._]*[-a-zA-Z0-9])(?::\d{2,5})?(?:[/?#](?:[^\s"'<>\][()]*[^\s"'<>\][().,])?(?:(?:\.(?:tiff?|jpe?g|jpg|gif|png|svg|ico)|ipfs\/[a-z\d]{40,})))/gi;
...
export const videoPreviewRegex = /<center>[\s\S]+<\/center>/;

export const videoPreviewRegex2 = /<center>(.*?)<\/center>/;
